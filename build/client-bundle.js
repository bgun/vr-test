...
/***/ function(module, exports) {
	...
	game.makeTurret = function (x, y, z) {
	  ...
	  var base = new THREE.Mesh(new THREE.CylinderGeometry(65, 65, 6, 32, 1, false), game.materials.metalMaterial);
	  base.castShadow = true;
	  base.receiveShadow = true;
	  base.position.setY(3);

	  var base2 = new THREE.Mesh(new THREE.CylinderGeometry(64, 70, 16, 8, 1, false), game.materials.metalWireMaterial);
	  base2.castShadow = true;
	  base2.receiveShadow = true;
	  base2.position.setY(8);
	  base2.rotation.set(22.5);

	  var dome = new THREE.Mesh(new THREE.SphereGeometry(50, 32, 32, 0, Math.PI * 2, 0, Math.PI / 2), game.materials.metalMaterial);
	  ...
	  var gun = new THREE.Mesh(new THREE.LatheGeometry(lathePts, 4), game.materials.metalFlatMaterial);
	...
	game.makeBadGuy = function () {
	  ...
	  badguy.properties = {};
	  var shell = new THREE.Mesh(new THREE.SphereGeometry(40, 16, 4, 0, Math.PI * 2, 0, Math.PI / 2), game.materials.badguyMaterial);
	  shell.position.y = 0;
